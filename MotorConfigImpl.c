...
void initMotorConfig()
{
	...
	CONFIG_MOTOR(bucketGroup[SIDE_LEFT], servoRightBucket, TYPE_SERVO, true)
	CONFIG_MOTOR(bucketGroup[SIDE_RIGHT], servoLeftBucket, TYPE_SERVO, true)
	CONFIG_MOTOR(bucketRack, servoRack, TYPE_SERVO, true)
